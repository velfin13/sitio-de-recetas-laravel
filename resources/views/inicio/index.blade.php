                                    ...
                                    <div class="latest-recipe-card">
                                        ...
                                        <div class="content">
                                            <div class="body">
                                                ...
                                                <h6 class="created_by">
                                                    {{ Str::words(strip_tags($nueva->preparacion), 8) }}</h6>
                                            </div>
                                            <div class="footer">
                                                <span class="likes"><i class="fas fa-heart"></i><b
                                                        class="counter">{{ count($nueva->likes) }}</b></span>
                                                <span
                                                    class="date">{{ date('d-m-Y', strtotime($nueva->created_at)) }}</span>
                                            </div>
                                        </div>
                                        <div class="see-more">
                                            <span><a href="{{ route('recetas.show', ['receta' => $nueva->id]) }}">Ver
                                                    👀</a></span>
                                        </div>
                                    </div>
                                    <!-- END LATEST CARD -->
                                                    ...
                                                    @if (count($recetas) == 0)
                                                        <li class="splide__slide">
                                                            <div class="recipe-card text-center"
                                                                ...
                                                                <span
                                                                    style="font-size: 50px; margin: 10px; color: grey;">😔</span>
                                                                <h5>No se encontraron recetas para <br>
                                                                    <b>{{ str_replace('-', ' ', $key) }}</b></h5>
                                                            </div>
                                                        </li>
                                                    @endif

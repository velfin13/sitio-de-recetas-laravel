...
<div class="container-fluid">
    ...
    <section id="profile">
        ...
        <div class="my-profile row">
            <div class="my-profile__avatar col-12">
                <div class="my-profile__avatar-image">
                    ...
                    @else
                    <img class="rounded-circle" src="{{ asset('images/avatarEmpty.jpg')}}" alt="img" style="width: 15rem; height: 15rem;">
                    @endif
                </div>
                <div class="my-profile__avatar-name" style="margin-top: 20px;">
                    <h4><b>{{ $perfil->usuario->name }}</b></h4>
                </div>
            </div>
            ...
            <div class="my-profile__bio col-12 text-center" style="justify-content: center; align-items: center; align-content: center; display: flex;">
                        ...
                        <a href="{{ route('recetas.show', ['receta' => $receta->id]) }}">
                            <div class="recipe-card">
                                <div class="top">
                                    <div class="left">
                                        <!-- {{ $receta->url }} -->
                                        <h5><b>{{ Str::words(strip_tags($receta->titulo), 17) }}</b></h5>
